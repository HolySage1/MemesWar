...
const settings = {
  ...
  GUILD_BONUS: "ba433424-d80a-4903-8700-08c6cc9cb5b8",
  ...
  BONUS: process.env.BONUS ? parseInt(process.env.BONUS) : 100,
  ID_MAIN_GUILD: process.env.ID_MAIN_GUILD ? process.env.ID_MAIN_GUILD : "ba433424-d80a-4903-8700-08c6cc9cb5b8",
